...
console.log(chats);
    ...
    useEffect(()=>{
        ...
        .then((response)=>{
            // console.log(response.data.data,"sfgss");
    ...
    return (
    <>
      <div className="sticky top-0  bg-white w-12/12 ml-auto p-2 flex gap-4 items-center shadow-md">
      ...
      <div className="">
        {
            ...
            chats.map((item)=>(
                <div className={`${item.sender.id==localStorage.getItem("userId")?"ml-auto mt-10":"ml-4 mt-10"} p-4 w-6/12 border border-slate-100 rounded-md`}>
